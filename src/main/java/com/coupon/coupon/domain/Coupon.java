...
public class Coupon {
    ...
    public void setCouponExpirationDate(String expiration_date) {
        this.expiration_date = expiration_date;
    }
    public String getCouponExpirationDate() {
        return expiration_date;
    }
    public void setCouponTotalQuantity(Long total_quantity) {
        this.total_quantity = total_quantity;
    }
    public Long getCouponTotalQuantity() {
        return total_quantity;
    }
    public void setCouponRemainingQuantity(Long remaining_quantity) {
        this.remaining_quantity = remaining_quantity;
    }
    public Long getCouponRemainingQuantity() {
        return remaining_quantity;
    }
